...
from tg_bot import dispatcher, CallbackContext, OWNER_ID, SUDO_USERS, SUPPORT_USERS, STRICT_GMUTE, SUPPORT_CHAT
...
def __user_info__(user_id):
    ...
    if int(user_id) in SUDO_USERS or int(user_id) in SUPPORT_USERS:
        text = "Globally muted: <b>Immortal</b>"
    else:
...
GMUTE_STATUS = CommandHandler("gmutestat", gmutestat, run_async=True, filters=Filters.chat_type.groups)
